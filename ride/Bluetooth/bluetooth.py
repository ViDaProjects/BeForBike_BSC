...
class BleManager(QThread):
    ...
    def __init__(self, company_id, secret_key, sendRideDataQueue: Queue, ProcessCrankDataQueue: Queue, FileManagerQueue: Queue, parent=None,fixed_mac: str = "01:23:45:67:90:E7"):
            ...
            while(self.is_running):
                ...
                try:
                    ...
                    try:
                        ...
                        logging.error(f"Erro ao obter dados da fila principal: {e}")
                        await asyncio.sleep(0.1)
                        continue
                ...
                for i in range(0, len(data_list), BATCH_SIZE):                    
                    ...
                    if self.ride_name: # Garante que só deleta se o nome do ride foi pego da fila principal
                        ...
                        self.asked = False # Permite nova busca de arquivos
